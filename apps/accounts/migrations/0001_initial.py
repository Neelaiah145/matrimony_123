    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_provider', models.CharField(blank=True, choices=[('PHONE', 'Phone'), ('EMAIL', 'Email'), ('GOOGLE', 'Google')], default='PHONE', max_length=20, null=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='register_for',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='users', to='accounts.registerfor'),
        ),
        migrations.CreateModel(
            name='Role',
            fields=[
